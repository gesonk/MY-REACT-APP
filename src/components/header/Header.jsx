...
const Header = () => {
    ...
    window.addEventListener('scroll', function () {
        ...
        // When the scroll is higher than 200 viewport height, add the class scroll-header to the header tag
